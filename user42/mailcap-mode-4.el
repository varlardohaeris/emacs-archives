...
;;
;; There's autoload cookies for all of the above, if you know how to use
;; `update-file-autoloads' and friends or use `M-x install-package'.

;; If you have Debian packagename.mime files in other directories then you
;; might like to *.mime anywhere not just under a debian subdir,
;;
...
The are optional parameters which don't take an \"=value\".
