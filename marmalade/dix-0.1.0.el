...
(defvar dix-char-alist
  ...
  '((?a 225)
    ...
    (?C 331820))
  "Sými alphabet:
ýaertguiopýKýýlkjhgfdsazcvbnmý`ERTfUIOPýJýýLKJHGFDSAZCVBNM")
...
(defvar dix-asciify-table
  ...
  "Converts Sými characters into ascii equivalent.")

(defun dix-asciify (str)
  "Used before sorting to turn ý into a, etc."
  (let ((cpos 0))
...
\"ýygruppe\", in the dix file below all the nouns, put point
between \"ýy\" and \"gruppe\", and if \"gruppe\" is defined
somewhere above, this function will turn the word into:

<e lm=\"ýygruppe\">    <i>ýygrupp</i><par n=\"lý/e__n\"/></e>
...
<e><p><l>ja<b/>nu<b/>ain<s n=\"Adv\"/></l><r>og<b/>sý<b/>videre<s n=\"adv\"/></r></p></e>
kýnske:kanskje
lahka:slags
...
<e><p><l>ja<b/>nu<b/>ain<s n=\"Adv\"/></l><r>og<b/>sý<b/>videre<s n=\"adv\"/></r></p></e>
<e><p><l>kýnske<s n=\"Adv\"/></l><r>kanskje<s n=\"adv\"/></r></p></e>
