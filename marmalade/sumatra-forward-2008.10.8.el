;;; sumatra-forward.el --- Provides Sumatra Forward search
;; Author: William Bloom
;; Version: 2008.10.08

;; Change Log:
;; 11-Feb-2011    Matthew L. Fidler  
;;    Took out the global f8 key binding, made it specific for LaTeX and Tex mode.
...
(add-hook 'LaTeX-mode-hook (lambda() (local-set-key [f8] 'sumatra-jump-to-line)))
(add-hook 'tex-mode-hook (lambda() (local-set-key [f8] 'sumatra-jump-to-line)))
